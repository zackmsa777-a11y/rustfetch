...
mod tests {
    #[test]
    fn macos_modules_link_symbols() {
        let _ = super::sysctl::sysctl_string("kern.ostype");
        ...
        let _ = super::packages::detect_packages();
        let _ = super::shell::detect_shell();
        let _ = super::terminal::detect_terminal();
        let _ = super::battery::detect_battery_and_power();
